  ...
  return (
    <div className="filter-toolbar">
      <div className="search-field">
        <input value={filters.search} onChange={(event) => onChange({ search: event.target.value })} placeholder="Введите текст для поиска" />
        <button type="button" className="search-field__icon" aria-label="Search"><Search size={18} /></button>
      </div>
